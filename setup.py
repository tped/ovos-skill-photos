...
URL = "https://github.com/tped/ovos-skill-photos"
SKILL_CLAZZ = "PhotoSkill"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-photos"  # pip install PYPI_NAME
